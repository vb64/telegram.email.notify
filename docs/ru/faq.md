...
## Мне нужно, чтобы в Телеграм публиковались только темы сообщений без содержимого email. Как это сделать?
...
В выбранном чате при поступлении email с указанного адреса будет публиковаться только текст темы email.
