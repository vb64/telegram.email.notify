...
EmailGateBot не может отправлять исходящие email из Telegram и абсолютно безопасен, т.к. не требует доступа к вашим почтовым аккаунтам, как, например, GmailBot и другие подобные боты.
