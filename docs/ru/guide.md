...
В этом случае сообщение будет опубликовано в чате Telegram в указанное время. Время указывается по Гринвичу, не забудьте отнять смещение вашего часового пояса. Строка с кодом не будет включена в публикуемое сообщение. Вы можете планировать отложенные сообщения на 30 дней вперед.
...
Текст в заголовке кнопки может содержать коды, отображаемые как значки эмодзи. Полный список кодов эмодзи можно посмотреть тут или воспользоваться командой `/emojicode` бота для получения кода нужного значка.
